...
# Next Steps for ndx-holographic-stimulation Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-holographic-stimulation directory.
...
`spec/ndx-holographic-stimulation.namespace.yaml` and
`spec/ndx-holographic-stimulation.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-holographic-stimulation
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/alessandratrapani/ndx-holographic-stimulation/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-holographic-stimulation/0.1.0
...
`staged-extensions/ndx-holographic-stimulation`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-holographic-stimulation
    ```

13. Edit `staged-extensions/ndx-holographic-stimulation/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/alessandratrapani/ndx-holographic-stimulation
...
14. Edit `staged-extensions/ndx-holographic-stimulation/README.md`
to add information about your extension. You may copy it from
`ndx-holographic-stimulation/README.md`.

  ```bash
  cp ndx-holographic-stimulation/README.md staged-extensions/ndx-holographic-stimulation/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-holographic-stimulation
git commit -m "Add new catalog entry for ndx-holographic-stimulation" .
git push
```
...
ndx-holographic-stimulation-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-holographic-stimulation GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-holographic-stimulation-record repository on GitHub.
